...
retired from admission for dependency, semantic-fidelity, solved-problem, or maintainer-request
reasons and are absent from the deny-by-default allowlist. The source
