...
[`tier-1`](https://github.com/conjectures-io/conjectures-tasks/tree/main/pool/tier-1) contains 137
active audited targets (118 Erdős targets and 19 Green's Open Problems targets), including complete
statements and independently formalized parts or variants. Nine additional audited targets are
retired from admission — six for dependency or semantic-fidelity defects, three after a verified
...
correction patch. The tier contains 274 active immutable bundles for 137 theorem targets. Every
...
the 137 active audited direct propositions, generates committed `formalized` and
