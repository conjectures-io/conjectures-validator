...
[`tier-1`](https://github.com/conjectures-io/conjectures-tasks/tree/main/pool/tier-1) contains 134
active audited targets (117 Erdős targets and 17 Green's Open Problems targets), including complete
...
correction patch. The tier contains 268 active immutable bundles for 134 theorem targets. Every
...
the 134 active audited direct propositions, generates committed `formalized` and
