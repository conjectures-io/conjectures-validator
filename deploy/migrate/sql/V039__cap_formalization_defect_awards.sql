-- Review policy v3 pays the lesser of $750 converted to Alpha and the submission bounty lock.
-- Prior submission contracts retain their fixed-USD awards. Existing reward rows are not edited.
