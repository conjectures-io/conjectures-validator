...
| 6 | active after dependency and semantic-fidelity retirements | **169** targets from 148 files (146 Erdős over 128 files, 23 Green over 20) |
| 7 | active after retiring settled or literature-solved targets | **164** targets from 143 files (143 Erdős over 125 files, 21 Green over 18) |
