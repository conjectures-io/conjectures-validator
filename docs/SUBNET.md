...
- an audited allowlist of 590 proof/counterexample bundles for 295 active theorem targets (238
  Erdős, 24 Green, 32 Wikipedia, and one Millennium) in 295 stable reward targets, with retired targets recorded
